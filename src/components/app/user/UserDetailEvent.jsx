...
export default function UserDetailEvent({ event }) {
  ...
  return (
    <div
      ...
      className="cursor-pointer mx-auto  bg-[#13131399] backdrop-blur-[50px] rounded-xl shadow-md overflow-hidden m-3"
    >
      <div className="md:flex">
        ...
        <div className="p-5 w-full">
          <div className="flex items-center justify-between">
            ...
            <div className="bg-[#F2C861] capitalize px-2 text-[10px] font-normal rounded-[6px]">
              {event?.status}
            </div>
          </div>
