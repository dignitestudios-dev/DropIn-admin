...
export default function EventDetailHeader() {
  return (
    <div className="bg-[#13131399]  flex justify-between  m-5 mt-24 p-3 rounded-[15px] h-[150px] gap-8 backdrop-blur-[50px]">
      <div className="flex relative w-full items-center  gap-3 border-r border-[#D7D7D7] ">
      ...
      <div className="w-full border-r border-[#D7D7D7]">
