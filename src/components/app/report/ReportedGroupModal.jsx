...
export default function ReportedGroupModal({ isOpen, setIsOpen, groupDetail }) {
                ...
                <div className="p-2 border-b border-[#313131] pb-5">
                  ...
                  <div className="flex justify-between gap-8 items-center">
                    <div className="flex items-center w-full border-r border-[#313131] gap-3 mt-2 text-white">
                      <img
                        src={groupDetail?.group?.groupImage || Logo}
                        alt="Profile"
                      ...
                      <div>
                        ...
                        <p className="text-[16px] text-[#959393] font-[400]">{groupDetail?.type}</p>
                      </div>
                    </div>
                    <div className="w-full ">
                      ...
                      <img
                        src={groupDetail?.reportedUser?.profilePicture}
                        alt="Profile"
                        className="w-10 h-10 rounded-full"
                      />
                      <div>
                        <span className="text-nowrap font-medium text-[16px]">
                          {groupDetail?.reportedUser?.firstName}
                        </span>
                      </div>
                      </div>
                    </div>
                 ...
                 <div className="p-2 border-b border-[#313131] pb-5">
                  ...
                  <div className="flex justify-between gap-8 items-center">
                    <div className="flex items-center w-full border-r border-[#313131] gap-3 mt-2 text-white">
                      <img
                        src={groupDetail?.reporter?.profilePicture}
                        alt="Profile"
                        className="w-10 h-10 rounded-full"
                      />
                      <div>
                        <span className="text-nowrap font-medium text-[16px]">
                          {groupDetail?.reporter?.firstName}
                        </span>
                      </div>
                    </div>
                    <div className="w-full">
                      ...
                      <span className="text-[16px] text-white font-[400]">
                        {dateFormate(groupDetail?.createdAt)}
                      </span>
                    </div>
                  </div>
                </div>
